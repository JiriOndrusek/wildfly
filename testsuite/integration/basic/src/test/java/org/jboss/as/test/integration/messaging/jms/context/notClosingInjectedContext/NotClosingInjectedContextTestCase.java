...
import org.jboss.as.test.integration.messaging.jms.context.notClosingInjectedContext.auxiliary.Cdi;
import org.jboss.as.test.integration.messaging.jms.context.notClosingInjectedContext.auxiliary.Cdi2;
...
//            }
            ...
            for (ModelNode line : lines) {
                if (line.asString().contains("IJ000100:")) {
                    Assert.fail("Context is not closed");
                }
            }
        }
    }
